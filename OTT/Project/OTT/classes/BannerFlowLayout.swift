...
//  OTT
//
//  Created by Rajesh Nekkanti on 10/05/20.
...
public class BannerFlowLayout: UICollectionViewLayout {
    ...
    public var autoPlayStatus: AutoPlayStatus = .none {
        didSet {
            ...
            case .play(let duration):
                timer = Timer.scheduledTimer(timeInterval: duration, target: self, selector: #selector(BannerFlowLayout.autoScroll), userInfo: nil, repeats: true)
