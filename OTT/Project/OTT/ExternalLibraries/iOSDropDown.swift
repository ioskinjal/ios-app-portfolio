...
open class DropDown : UITextField{
    ...
    public var selectedTextColor: UIColor = UIColor.init(hexString: "020202")
    var defaultTextColor = UIColor.init(hexString: "020202")
    //MARK: IBInspectable
    ...
    @IBInspectable public var arrowColor: UIColor = UIColor.init(hexString: "94969f") {
        didSet{
...
class Arrow: UIView {
    ...
    var arrowColor:UIColor = UIColor.init(hexString: "94969f") {
        didSet{
