...
- (IBAction)channelBtnClicked:(UIButton *)sender {
    
    NSDictionary *channelDic = [NSDictionary dictionaryWithObject:[NSNumber numberWithInt:sender.tag] forKey:@"channelIndex"];
    
    [[NSNotificationCenter defaultCenter] postNotificationName:@"ChannelButtonClicked" object:self userInfo:channelDic];
}
