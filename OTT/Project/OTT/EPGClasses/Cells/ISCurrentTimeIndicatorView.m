...
- (void)awakeFromNib
{
    ...
    NSDateComponents *components = [calendar components:(NSYearCalendarUnit | NSMonthCalendarUnit | NSCalendarUnitDay | NSHourCalendarUnit | NSMinuteCalendarUnit) fromDate:oneMinuteInFuture];
...
- (void)updateTime
{
    ...
    self.currentTimeLabel.textColor = [UIColor redColor];
}
