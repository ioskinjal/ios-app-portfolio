...
extension UIView.KeyframeAnimationOptions {
    ...
    get {
        return UIView.KeyframeAnimationOptions.init(rawValue: UIView.AnimationOptions.curveEaseIn.rawValue )
//        return UIView.KeyframeAnimationOptions(animationOptions: .curveEaseIn)
    ...
    get {
        return UIView.KeyframeAnimationOptions.init(rawValue: UIView.AnimationOptions.curveEaseOut.rawValue )
//        return UIView.KeyframeAnimationOptions(animationOptions: .curveEaseOut)
    ...
    get {
        return UIView.KeyframeAnimationOptions.init(rawValue: UIView.AnimationOptions.curveEaseInOut.rawValue )
//        return UIView.KeyframeAnimationOptions(animationOptions: .curveEaseInOut)
    ...
    get {
        return UIView.KeyframeAnimationOptions.init(rawValue: UIView.AnimationOptions.curveLinear.rawValue )
