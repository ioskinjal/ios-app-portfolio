...
@property(nonatomic, strong) IBOutlet UIImageView *chromeCastFocusImageView;//only for Chromecast
@property(nonatomic, strong) IBOutlet UINavigationBar *airplayNavigationBar;
@property(nonatomic, strong) IBOutlet UILabel *airplayMessageLabel;//only for Chromecast
@property(nonatomic, strong) IBOutlet UIButton *chromecastOkButton; //only for Chromecast
@property(nonatomic, strong) IBOutlet UIView *grayLayoutView;
