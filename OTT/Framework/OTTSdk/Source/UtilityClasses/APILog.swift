...
public class APILog: NSObject {
    ...
    public static func defaultHeaders() -> NSString{
        return "box-id : \(YuppTVSDK.preferenceManager.boxId)" + "\n" + "session-id : \(PreferenceManager.sessionId)"  as NSString
    }
    ...
    internal static func attributedText(message : String, logType : LogType) -> NSMutableAttributedString{
        ...
        let yourAttributes = [NSForegroundColorAttributeName: color, NSFontAttributeName: font] as [String : Any]
