//
//  SearchCategoryHit.swift
//  Created on June 29, 2020

import Foundation


class SearchCategoryHit : NSObject, NSCoding{

    var id : String!
    var index : String!
    var score : Int!
    var source : SearchCategorySource!
    var type : String!
    ...
    init(fromDictionary dictionary: [String:Any]){
        ...
        if let sourceData = dictionary["_source"] as? [String:Any]{
            source = SearchCategorySource(fromDictionary: sourceData)
        }
    }
    ...
    @objc required init(coder aDecoder: NSCoder)
    {
        ...
        source = aDecoder.decodeObject(forKey: "_source") as? SearchCategorySource
