//
//  MainElasticHit.swift
//  Created on June 27, 2020

import Foundation


class MainElasticHit : NSObject, NSCoding{

    var id : String!
    var index : String!
    var score : Float!
    var source : MainElasticSource!
    var type : String!
    ...
    init(fromDictionary dictionary: [String:Any]){
        ...
        score = dictionary["_score"] as? Float
        type = dictionary["_type"] as? String
        if let sourceData = dictionary["_source"] as? [String:Any]{
            source = MainElasticSource(fromDictionary: sourceData)
        }
    }
    ...
    @objc required init(coder aDecoder: NSCoder)
    {
        ...
        score = aDecoder.decodeObject(forKey: "_score") as? Float
        source = aDecoder.decodeObject(forKey: "_source") as? MainElasticSource
