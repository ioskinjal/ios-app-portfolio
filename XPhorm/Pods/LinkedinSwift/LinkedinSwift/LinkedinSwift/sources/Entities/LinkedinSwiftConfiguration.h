 ...
 *  Init with settings
 *
 *  @param _clientId     Linkedin client id
 *  @param _clientSecret Linkedin client secret
 *  @param _state        state to identify each oauth redirect calls, make a unique one
 *  @param _permisssions Linkedin permissions to ask
