...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    private func redirectToVC(){
        ...
        let viewController = mainStoryboard.instantiateViewController(withIdentifier: "SplashVC") as! SplashVC
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        GMSPlacesClient.provideAPIKey("AIzaSyAWiP7i8NyBrWIGuDBDop0G4veZ3ZI7q9w")
          GIDSignIn.sharedInstance().clientID = "368979492548-m3b78sbc3gnv4fbvlrc571mflgik941f.apps.googleusercontent.com"
        redirectToVC()
