...
class WebRequester {
    ...
    func requestsWithImage(url:String, parameter:dictionary = dictionary(), withPostImage postImg:UIImage?, withPostImageName imgName:String?,isboth:Bool = false, withPostImageAry postImgsAry:[UIImage] = [UIImage](), withPostImageNameAry imgNameAry:[String] = [String](), withParamName:String,withparamUpload:String = "", completion:@escaping(Result<Any>)->Void){
        Modal.sharedAppdelegate.startLoader()
            ...
            multipartFormData: { multipartFormData in
                if isboth{
                    ...
                    multipartFormData.append(imgData,
                                             withName: withparamUpload, fileName: imgNm,
                                             mimeType: WebRequester.getMimeType(imageName: imgNm))
                    print("[\(withparamUpload)]: \(imgNm) => \(String(describing: postImg))")
                    print("**********************")
...
extension UIImageView{
   // placeHolderImage img: UIImage = #imageLiteral(resourceName: "small-Image-Place-Holder")
    func downLoadImage(url: String, placeHolderImage img: UIImage = #imageLiteral(resourceName: "proIco")) {
