...
extension UIButton {
    func underline() {
        ...
        func addBorder(side: BorderSide, color: UIColor, width: CGFloat) {
            ...
            case .customRight: break
                
            case .customBottom: break
...
extension UIImagePickerController{
    ...
    private func openGalleryOrPhotoLibrary(vc: UIViewController,sourceType:UIImagePickerController.SourceType,allowsEditing:Bool) {
...
extension UIImagePickerController{
    ...
    func getPickedFileName(info: [UIImagePickerController.InfoKey:Any]) -> String? {
...
extension Date{
    ...
    //
    //        let component: DateComponents = calendar.component(Calendar.Component.year, from: self)as DateComponents
    //        return component.year;
    //    }
    //    //Function will reutrn the current month Number
    //    func  get_Month() -> NSInteger {
    //        let calendar: Calendar = Calendar.current
    //        let component: NSDateComponents = calendar.components(Calendar.Unit.Month, from: self) as NSDateComponents
    ...
    //        let calendar: Calendar = Calendar.current
    //        let component: NSDateComponents = calendar.components(Calendar.Unit.Weekday, from: self) as NSDateComponents
