...
class BaseViewController: UIViewController {
    ...
    func setUpNavigation(vc:UIViewController, isBackButton:Bool = false, btnTitle:String = "", navigationTitle:String, action: Selector, isRightBtn:Bool = false, actionRight: Selector = #selector(onClickRightBtn(_:)), btnRightImg:UIImage = #imageLiteral(resourceName: "cart-ico") ){
        if isBackButton{
            navigationBar.btnMenu.setImage(#imageLiteral(resourceName: "back-ico"), for: UIControlState())
        }
        else{
