...
class HomeVC: BaseVC {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        goOnlineBtn.setTitle(appConts.const.bTN_ONLINE, for: .normal)
        goOfflineBtn.setTitle(appConts.const.bTN_OFFLINE, for: .normal)
        lblHome.text = appConts.const.tITLE_HOME
        tableSetup()
        // findMyLocation()
        loadCars()
        getPartnerStatus()
