...
class FavoriteVC: BaseVC {
    ...
    @IBOutlet weak var btnSaveLocations:UIButton!
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        lblTitle.text = appConts.const.hOME_LOC
        txtAddress.placeholder = appConts.const.pICK_LOC
        btnSaveLocations.setTitle(appConts.const.sAVELOC, for: .normal)
    }
    ...
    @IBAction func btnSaveLocationClicked(_ sender: Any) {
        ...
        if valid.isNotNull(object: txtAddress.text as AnyObject){
            ...
            let alert = Alert()
            alert.showAlert(titleStr: appConts.const.aLERT, messageStr: appConts.const.pLEASE_SELECT_PROPER_LOCATION, buttonTitleStr: appConts.const.bTN_OK)
