...
/**
 ...
 @param state YES if you want an alert to prompt the user to go to the App Store if the LinkedIn App is not installed. If NO, no alert will be shown and the user will be taken to the App Store directly.
 */
