...
class FollowingVC: BaseViewController {
    ...
    static var storyboardInstance:FollowingVC {
        return (StoryBoard.createEvent.instantiateViewController(withIdentifier: FollowingVC.identifier) as! FollowingVC)
    }
    ...
    func getFollowings(){
        ...
        API.shared.call(with: .getFollowings, viewController: self, param: param) { (response) in
...
extension FollowingVC: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        nextVC.userId = userList[indexPath.row].requester_userid
