...
class Const{
   ...
   var TITLE_SELFEI:String
    ...
    init(data: [String:Any]) {
        ...
        lBL_SELECT_CAR = data["LBL_SELECT_CAR"] as? String ?? "Please Select Vehicle"
        ...
        mSG_DELETE_CAR = data["MSG_DELETE_CAR"] as? String ?? "Are you sure you want to delete this Vehicle ?"
        ...
        cANNOT_OFFLINE = data["CANNOT_OFFLINE"] as? String ?? "You can't log out when you are online"
