...
extension RidesVC:UITableViewDataSource,UITableViewDelegate{
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if tableView == ridesTableView {
            ...
            let array:NSArray = currentRide.createdDateTimeFormatted.components(separatedBy: ",") as NSArray
            ...
            // Partener
            if currentRide.userFirstName == "" &&  currentRide.userLastName == "" {
                cell?.lblDriverName.text = "N/A"
            }else{
                cell?.lblDriverName.text = String(format: "%@ %@",currentRide.userFirstName,currentRide.userLastName)
            }
