...
class WSManager: NSObject {
    ...
    class func getResponseFromMultiPartSignature(serviceUrl:String,parameters:Dictionary<String, Any>,image:Image
        ,successBlock:@escaping SuccessBlock,failureBlock:@escaping FailureBlock ){
        ...
        manager.upload(multipartFormData: { (multipartFormData:MultipartFormData)  in
            ...
            multipartFormData.append(imageData!, withName: "signature", fileName: "signature.png", mimeType: "image/png")
