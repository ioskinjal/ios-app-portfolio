...
extension DropDown {
	...
	*/
    ...
    public func selectRow(at index: Index?, scrollPosition: UITableView.ScrollPosition = UITableView.ScrollPosition.none) {
		if let index = index {
            tableView.selectRow(
    ...
    @objc public func selectRow(_ index: Int, scrollPosition: UITableView.ScrollPosition = UITableView.ScrollPosition.none) {
