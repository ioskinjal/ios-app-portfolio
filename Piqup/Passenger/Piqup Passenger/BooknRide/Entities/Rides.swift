...
class Rides: NSObject {
    ...
    class func initWithResponse(array:[Any]?) -> [Any]{
        ...
        for case let item as NSDictionary in tempArray {
            ...
            if valid.isNotNull(object: item.object(forKey: "is_cancel_btn") as AnyObject){
                code.is_cancel_btn = String(format:"%@",item.object(forKey: "is_cancel_btn") as! NSString)
            }else{
                code.is_cancel_btn = "N/A"
            }
            
            if valid.isNotNull(object: item.object(forKey: "scheduledDatetime") as AnyObject){
                code.scheduledDatetime = String(format:"%@",item.object(forKey: "scheduledDatetime") as! NSString)
            }else{
                code.scheduledDatetime = "N/A"
            }
...
class RideTripDetails : NSObject{
    ...
    class func initWithResponse(dictionary:[String:Any]?) -> RideTripDetails {
        ...
        if valid.isNotNull(object: dictFare.object(forKey: "recipientEmail") as AnyObject){
            fare.recipientEmail = "\(dictFare.object(forKey: "recipientEmail") ?? "")"
        }
        ...
        if valid.isNotNull(object: dictFare.object(forKey: "recipientPhone") as AnyObject){
            fare.recipientPhone = "\(dictFare.object(forKey: "recipientPhone") ?? "")"
        }
        ...
        if valid.isNotNull(object: dictFare.object(forKey: "number_of_extra_person_required") as AnyObject){
            fare.number_of_extra_person_required = "\(dictFare.object(forKey: "number_of_extra_person_required") ?? "")"
        }
        ...
        if valid.isNotNull(object: dictFare.object(forKey: "weight") as AnyObject){
            fare.weight = String(format:"%d",dictFare.object(forKey: "weight") as! Int)
        }
        if valid.isNotNull(object: dictFare.object(forKey: "height") as AnyObject){
            fare.height = String(format:"%d",dictFare.object(forKey: "height") as! Int)
        }
        if valid.isNotNull(object: dictFare.object(forKey: "width") as AnyObject){
            fare.width = String(format:"%d",dictFare.object(forKey: "width") as! Int)
        }
        if valid.isNotNull(object: dictFare.object(forKey: "breadth") as AnyObject){
            fare.breadth = String(format:"%d",dictFare.object(forKey: "breadth") as! Int)
        }
        ...
        if valid.isNotNull(object: dictFare.object(forKey: "fareAdditionalCharges") as AnyObject){
            fare.fareAdditionalCharges = String(format:"%d", dictFare.object(forKey: "fareAdditionalCharges") as! String)
        ...
        if valid.isNotNull(object: dictFare.object(forKey: "fareDistanceCharges") as AnyObject){
            fare.fareDistanceCharges = dictFare.object(forKey: "fareDistanceCharges") as! String
        }
        ...
        if valid.isNotNull(object: dictFare.object(forKey: "fareTimeCharges") as AnyObject){
            fare.fareTimeCharges = dictFare.object(forKey: "fareTimeCharges") as! String
        }
        ...
        if valid.isNotNull(object: dictFare.object(forKey: "payByCash") as AnyObject){
            fare.payByCash = dictFare.object(forKey: "payByCash") as! String
        }
        if valid.isNotNull(object: dictFare.object(forKey: "payByWallet") as AnyObject){
            fare.payByWallet = dictFare.object(forKey: "payByWallet") as! String
        }
        ...
        if valid.isNotNull(object: dictFare.object(forKey: "rating") as AnyObject){
            fare.rating = "\(dictFare.object(forKey: "rating") ?? "")"
        }
        ...
        if valid.isNotNull(object: dictFare.object(forKey: "totalCharges") as AnyObject){
            fare.totalCharges = dictFare.object(forKey: "totalCharges") as! String
        }
        ...
        if valid.isNotNull(object: dictFare.object(forKey: "totalExtraCharges") as AnyObject){
            fare.totalExtraCharges = dictFare.object(forKey: "totalExtraCharges") as! String
        }
        ...
        if valid.isNotNull(object: dictFare.object(forKey: "totalRating") as AnyObject){
            fare.totalRating = dictFare.object(forKey: "totalRating")as! Int  
        }
        ...
        if valid.isNotNull(object: dictFare.object(forKey: "totalTimeCharges") as AnyObject){
            fare.totalTimeCharges = dictFare.object(forKey: "totalTimeCharges") as! String
        }
...
class RideInfo : NSObject{
    ...
    class func initWithResponse(dictionary:[String:Any]?) -> RideInfo {
        ...
        if valid.isNotNull(object: dictFare.object(forKey: "number_of_extra_person_required") as AnyObject){
            fare.number_of_extra_person_required = String(format:"%@",dictFare.object(forKey: "number_of_extra_person_required") as! CVarArg)
            
        }
        
        if valid.isNotNull(object: dictFare.object(forKey: "avgRatting") as AnyObject){
            fare.avgRatting = String(format:"%@",dictFare.object(forKey: "avgRatting") as! CVarArg)
