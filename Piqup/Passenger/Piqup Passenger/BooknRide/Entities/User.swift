...
class User: NSObject {
    ...
    class func initWithResponse(dictionary:[String:Any]?) -> User {
        ...
        if valid.isNotNull(object: dictionary["currenctBalance"] as AnyObject){
            person.currenctBalance = String(format:"%d",item.object(forKey: "currenctBalance") as? Double ?? 0.0)
            if person.currenctBalance == "0"{
                person.currenctBalance = item.object(forKey: "currenctBalance")as? String ?? ""
            }
        ...
        if valid.isNotNull(object: dictionary["onlineWithCarId"] as AnyObject){
            person.onlineWithCarId = String(format:"%@",item.object(forKey: "onlineWithCarId") as! NSString)

        }
        if valid.isNotNull(object: dictionary["onlineWithCarTypeId"] as AnyObject){
            person.onlineWithCarTypeId = String(format:"%@",item.object(forKey: "onlineWithCarTypeId") as! NSString)
        ...
        person.register = item.object(forKey: "register") as? String ?? ""
...
class Language:NSObject{
    ...
    init(data:[String:Any]) {
        ...
        self.languageName = data["languageName"] as? String ?? "N/B"
        self.defaultLanguage = data["default_lan"] as? String ?? "N/B"
    }
...
//    var REDEEM_HISTORY:String
    ...
    var LBL_SETTINGS:String
    var MSG_NETWORK:String
    var MSG_NO_INTERNET:String
    var LBL_SELECT_LANGUAGE:String
    var REQ_SOCIAL_EMAIL:String
    var MSG_COUNTRY_SELECTION:String
    var LBL_PICKUP:String
    var MSG_DELETE_HOME:String
    var MSG_DELETE_WORK:String
    var MSG_SELECT_IMAGE:String
    var MSG_TAKE_PHOTO:String
    var MSG_CHOOSE_PHOTO:String
    var MSG_SELECT_LOCATION:String
    var REQ_AMOUNT    :String
    var REQ_VALID_AMOUNT    :String
    var MSG_PAYMENT_FAILED    :String
    var LBL_ACCEPTED:String
    var LBL_WALLET:String
    var LB_ACTIVE:String
    var LBL_CASH    :String
    var MSG_ENTER_REVIEW    :String
    var MSG_SELECT_LANGUAGE:String
    var MSG_iCLOUD:String
    var MSG_SAVE_ERROR:String
    var MSG_PANIC_UPDATE    :String
    var LBL_RIDE_TIME    :String
    var MSG_SELFIE:String
    var TITLE_SELFEI:String
    var PLEASE_UPLOAD_SELFIE    :String
    
    var MSG_RIDE_ACCEPTED:String
    var MSG_RIDE_CANCELLED:String
    
    var LBL_ENTER_DEPOSIT_AMOUNT:String
    var LBL_PAYMENT:String
    
    var MSG_PICKUP_LOCATION:String
    var MSG_LOCATION_REMOE_SUCCESS:String

    var MSG_PASSWORD_NOT_SAME:String
    var MSG_NEW_CONFIRM_PASSWORD:String
    var PLEASE_ENTER_COUNTRY_CODE:String
    var CHANGE_CONTACT_NO:String
    ...
    init(data: [String:Any]) {
        ...
        tITLE_FINANCIAL_INFO = data["TITLE_FINANCIAL_INFO"] as? String ?? "Wallet"
        ...
        rATTINGS = data["RATTINGS"] as? String ?? "Rattings"
        ...
        bOOK_N_RIDE = data["BOOK_N_RIDE"] as? String ?? "Karryy"
        ...
        cHANGE_CONTACT = data["CHANGE_CONTACT"] as? String ?? "Change emrergency Contact Details"
        cHANGE_SETTINGS = data["CHANGE_SETTINGS"] as? String ?? "Change Notification Settings"
        mSG_INVALID_CONTACT = data["MSG_INVALID_CONTACT"] as? String ?? "Please enter emergency contact number"
        ...
        nO_HOME_LOC = data["NO_HOME_LOC"] as? String ?? "No Hom Location Set"
...
//        REDEEM_REQ_MSG = data["REDEEM_REQ_MSG"] as? String ?? "This amount is can br use to book a ride."
//        REDEEM_HISTORY = data["REDEEM_HISTORY"] as? String ?? "This amount is the amount you requested to redeem."
//        CURRENT_BAL_MSG = data["CURRENT_BAL_MSG"] as? String ?? "Current Balance"
       ...
       LBL_SETTINGS = data["LBL_SETTINGS"] as? String ?? "Settings"
       MSG_NETWORK = data["MSG_NETWORK"] as? String ?? "Network"
       MSG_NO_INTERNET = data["MSG_NO_INTERNET"] as? String ?? "No Internet connection, Go to settings to turn on the internet."
       LBL_SELECT_LANGUAGE = data["LBL_SELECT_LANGUAGE"] as? String ?? "Select language"
       REQ_SOCIAL_EMAIL = data["REQ_SOCIAL_EMAIL"] as? String ?? "Please select email id in the social login"
       MSG_COUNTRY_SELECTION = data["MSG_COUNTRY_SELECTION"] as? String ?? "Country selection not available"
       LBL_PICKUP = data["LBL_PICKUP"] as? String ?? "Pickup"
       MSG_DELETE_HOME = data["MSG_DELETE_HOME"] as? String ?? "Do you want to delete home address?"
       MSG_DELETE_WORK = data["MSG_DELETE_WORK"] as? String ?? "Do you want to delete work address?"
       MSG_SELECT_IMAGE = data["MSG_SELECT_IMAGE"] as? String ?? "Select Image"
       MSG_TAKE_PHOTO = data["MSG_TAKE_PHOTO"] as? String ?? "Take Photo"
       MSG_CHOOSE_PHOTO = data["MSG_CHOOSE_PHOTO"] as? String ?? "Choose Photo"
       MSG_SELECT_LOCATION = data["MSG_SELECT_LOCATION"] as? String ?? "Please select location"
       REQ_AMOUNT = data["REQ_AMOUNT"] as? String ?? "Please enter amount"
       REQ_VALID_AMOUNT = data["REQ_VALID_AMOUNT"] as? String ?? "Please enter valid amount"
       MSG_PAYMENT_FAILED = data["MSG_PAYMENT_FAILED"] as? String ?? "Payment failed"
       LBL_ACCEPTED = data["LBL_ACCEPTED"] as? String ?? "Accepted"
       LBL_WALLET = data["LBL_WALLET"] as? String ?? "by Wallet"
       LB_ACTIVE = data["LB_ACTIVE"] as? String ?? "Active"
       LBL_CASH = data["LBL_CASH"] as? String ?? "by Cash"
       MSG_ENTER_REVIEW = data["MSG_ENTER_REVIEW"] as? String ?? "Please enter review"
       MSG_SELECT_LANGUAGE = data["MSG_SELECT_LANGUAGE"] as? String ?? "Please Select language"
       MSG_iCLOUD = data["MSG_iCLOUD"] as? String ?? "Attachment is saved on iCloud"
       MSG_SAVE_ERROR = data["MSG_SAVE_ERROR"] as? String ?? "Save error"
       MSG_PANIC_UPDATE = data["MSG_PANIC_UPDATE"] as? String ?? "Please update your panic number in account settings"
       LBL_RIDE_TIME = data["LBL_RIDE_TIME"] as? String ?? "Ride Time"
       MSG_SELFIE = data["MSG_SELFIE"] as? String ?? "You have already uploaded selfie"
       TITLE_SELFEI = data["TITLE_SELFEI"] as? String ?? "Upload selfie from below options and wait for approvement..."
       PLEASE_UPLOAD_SELFIE = data["PLEASE_UPLOAD_SELFIE"] as? String ?? "Please upload selfie"
        
        MSG_RIDE_ACCEPTED = data["MSG_RIDE_ACCEPTED"] as? String ?? "Your ride has been Accepted"
        MSG_RIDE_CANCELLED = data["MSG_RIDE_CANCELLED"] as? String ?? "Your ride has been cancelled"
        
        LBL_ENTER_DEPOSIT_AMOUNT = data["LBL_ENTER_DEPOSIT_AMOUNT"] as? String ?? "Enter deposit amount ($)"
        
        LBL_PAYMENT = data["LBL_PAYMENT"] as? String ?? "PAYMENT"
        MSG_PICKUP_LOCATION = data["MSG_PICKUP_LOCATION"] as? String ?? "Please select pickup location"
        
        MSG_LOCATION_REMOE_SUCCESS = data["MSG_LOCATION_REMOE_SUCCESS"] as? String ?? "Location removed successfully"
        
        MSG_PASSWORD_NOT_SAME = data["MSG_PASSWORD_NOT_SAME"] as? String ?? "New pasword and confirm new password not same."
        MSG_NEW_CONFIRM_PASSWORD     = data["MSG_NEW_CONFIRM_PASSWORD"] as? String ?? "Please enter new confirm password"

        PLEASE_ENTER_COUNTRY_CODE = data["PLEASE_ENTER_COUNTRY_CODE"] as? String ?? "Please enter country code"

        CHANGE_CONTACT_NO = data["CHANGE_CONTACT_NO"] as? String ?? "CHANGE CONTACT NUMBER"
    }
}
