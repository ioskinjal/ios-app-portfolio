...
class NotificationVC: BaseVC {
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        self.navTitle.text = appConts.const.nOTIFICATION
    }
...
extension NotificationVC:UITableViewDelegate{
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        if selectedNotification.status.lowercased() == "w" {
            ...
            let rideInfoController = RideInfoVC(nibName: "RideInfoVC", bundle: nil)
            ...
            let rideInfoController = RideStartedVC(nibName: "RideStartedVC", bundle: nil)
            rideInfoController.selecteRide = selectedRide
            self.navigationController?.pushViewController(rideInfoController, animated: true)
            ...
            let rideDetailVC = RideDetailsVC(nibName: "RideDetailsVC", bundle: nil)
            rideDetailVC.selecteRide = selectedRide
            self.navigationController?.pushViewController(rideDetailVC, animated: true)
