...
class HelpVC: BaseVC,UITextViewDelegate,UITextFieldDelegate {
   ...
   // @IBOutlet weak var lblGetInTouch:UILabel!
    //@IBOutlet weak var lblAlwaysWithinYourReach:UILabel!
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        //lblQuery.text = appConts.const.eNTER_UR_QUERY_HERE
        //txtMobileNumber.text = appConts.const.lBL_MOBILE_NO
        //btnSend.setTitle(appConts.const.bTN_SEND, for: .normal)
        //lblGetInTouch.text = appConts.const.lBL_IN_TOUCH
       // lblAlwaysWithinYourReach.text = appConts.const.lBL_IN_TOUCH_TAG
...
//    }
    ...
    func textViewDidBeginEditing(_ textView: UITextView) {
       // self.scrollView.setContentOffset(CGPoint(x: 0, y: self.signupView.frame.origin.y), animated: true)
