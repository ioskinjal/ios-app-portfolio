...
class MSSentVC: UIViewController,UITableViewDelegate,UITableViewDataSource
{

    @IBOutlet var tableSentMessage: UITableView!
    ...
    {
        let cell = tableView.dequeueReusableCell(withIdentifier:"MSSentTC",for: indexPath) as! MSSentTC
