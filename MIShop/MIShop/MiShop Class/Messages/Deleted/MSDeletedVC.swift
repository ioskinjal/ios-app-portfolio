...
class MSDeletedVC: UIViewController,UITableViewDelegate,UITableViewDataSource
{
    @IBOutlet var tableDeletedMessage: UITableView!
    ...
    {
        let cell = tableView.dequeueReusableCell(withIdentifier:"MSDeletedTC",for: indexPath) as! MSDeletedTC
