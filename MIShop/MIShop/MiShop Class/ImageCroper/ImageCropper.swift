...
class ImageCropper: UIViewController , UIScrollViewDelegate {
    ...
    override func viewDidAppear(_ animated: Bool) {
        ...
        let cropSize = self.setCropAspectRect(cropSize: CGSize(width: cropWidth, height: cropHeight), maxSize: self.cropContainer.bounds.size)
    ...
    func setCropAspectRect(cropSize: CGSize, maxSize: CGSize) -> CGSize {
