...
class WebRequester {
    ...
    func requests(url:String, method:HTTPMethod = .post, parameter:dictionary = dictionary(), isLoader:Bool = true, completion:@escaping(Result<Any>)->Void){
        ...
        if isLoader {
            ModelClass.sharedAppdelegate.startLoader()
        }
    ...
    func requestsWithImage(url:String, parameter:dictionary = dictionary(), withPostImage postImgs:UIImage?, withPostImageName imgName:String?, withPostImageAry postImgsAry:[UIImage] = [UIImage](), withPostImageNameAry imgNameAry:[String] = [String](), withParamName:String, withBannerImage: UIImage?, withPostImageName bannerimgName:String?, withbannerParamName:String, completion:@escaping(Result<Any>)->Void){
        ModelClass.sharedAppdelegate.startLoader()
